...
type IDatabaseService interface {
	...
	SaveBuilderBlockSubmission(payload *common.BuilderSubmitBlockRequest) (entry *BuilderBlockSubmissionEntry, err error)
...
func (s *DatabaseService) SaveBuilderBlockSubmission(payload *common.BuilderSubmitBlockRequest, RPBS *common.RpbsCommitResponse, transactionByte string) (err error) {
	...
	blockSubmissionEntry := &common.BuilderBlockSubmissionEntry{
